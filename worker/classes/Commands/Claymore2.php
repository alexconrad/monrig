...
class Claymore2 extends \Command {

	const FULLNAME = 'Claymore\'s Dual Ethereum+Decred_Siacoin_Lbry_Pascal AMD+NVIDIA GPU Miner v10.3';
	const BAT_FILE = 'I:'.DIRECTORY_SEPARATOR.'Mine'.DIRECTORY_SEPARATOR.'Claymore\'s Dual Ethereum+Decred_Siacoin_Lbry_Pascal AMD+NVIDIA GPU Miner v10.3'.DIRECTORY_SEPARATOR.'mystart.bat'; //FULL PATH
	...
	public function __construct()
	{
		...
		if (stristr($first_line, self::BAT_FIRST_LINE) === false) {
			fclose($fp);
